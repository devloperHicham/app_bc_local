...
@Component({
  selector: 'app-historique-comparison',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './historique-comparison.component.html',
  styleUrls: ['./historique-comparison.component.scss'],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class HistoriqueComparisonComponent implements OnInit {
  dtOptions: Config = {};

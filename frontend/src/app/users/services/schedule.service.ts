...
export class ScheduleService {
  ...
  constructor(
    ...
    this.url = `${this.configService.URL_API}${this.configService.ENDPOINTS.schedules}`;
  }

  getAll(): Observable<Schedule[]> {
    return this.http
      .get<ApiResponses<Schedule[]>>(this.url, this.configService.httpOptions)
      .pipe(
  ...
  show(id: string): Observable<Schedule | null> {
    const url = `${this.url}/${id}`;
    return this.http
      .get<ApiResponses<Schedule>>(url, this.configService.httpOptions)
      .pipe(
        map((response) => {
  ...
  update(id: string, data: Schedule): Observable<ApiResponses<void>> {
    const url = `${this.url}/${id}`;
    return this.http

...
export class TransportationService {
  ...
  constructor(
    ...
    this.url = `${this.configService.URL_API}${this.configService.ENDPOINTS.settings}/transportations`;
  }

  getAll(): Observable<Transportation[]> {
    const urls = `${this.url}/all`;
    return this.http
      .get<ApiResponses<Transportation[]>>(
        urls,
  ...
  show(id: string): Observable<Transportation | null> {
    const url = `${this.url}/${id}`;
    return this.http
      .get<ApiResponses<Transportation>>(url, this.configService.httpOptions)
      .pipe(
        map((response) => {
  ...
  create(data: Transportation): Observable<ApiResponses<void>> {
    return this.http
  ...
  update(id: string, data: Transportation): Observable<ApiResponses<void>> {
    const url = `${this.url}/${id}`;
    return this.http

...
export class UserService {
  ...
  getAll(): Observable<User[]> {
    ...
    return this.http
      .get<ApiResponses<User[]>>(urls, this.configService.httpOptions)
      .pipe(
  ...
  show(id: string): Observable<User | null> {
    const url = `${this.url}/${id}`;
    return this.http
      .get<ApiResponses<User>>(url, this.configService.httpOptions)
      .pipe(
        map((response) => {
  ...
  update(id: string, data: User): Observable<ApiResponses<void>> {
    const url = `${this.url}/${id}`;
    return this.http

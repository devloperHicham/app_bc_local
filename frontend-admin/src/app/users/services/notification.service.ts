...
import { NotificationResponse } from "../modules/notification";
...
export class NotificationService {
  ...
  show(): Observable<NotificationResponse  | null> {
    const url = `${this.url}/stats`;
    return this.http
      .get<ApiResponses<NotificationResponse >>(url, this.configService.httpOptions)
      .pipe(
        map((response) => {
  ...
  update(): Observable<ApiResponses<void>> {
    const url = `${this.url}/read`;
    return this.http
      .put<ApiResponses<void>>(url, "", this.configService.httpOptions)
      .pipe(
        map((response) => {

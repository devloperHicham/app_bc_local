...
export class FaqService {
  ...
  constructor(
    ...
    this.url = `${this.configService.URL_API}${this.configService.ENDPOINTS.settings}/faqs`;
  }

  getAll(): Observable<Faq[]> {
    return this.http
      .get<ApiResponses<Faq[]>>(this.url, this.configService.httpOptions)
      .pipe(
  ...
  show(id: string): Observable<Faq | null> {
    const url = `${this.url}/${id}`;
    return this.http
      .get<ApiResponses<Faq>>(url, this.configService.httpOptions)
      .pipe(
        map((response) => {
  ...
  create(data: Faq): Observable<ApiResponses<void>> {
    return this.http
  ...
  update(id: string, data: Faq): Observable<ApiResponses<void>> {
    const url = `${this.url}/${id}`;
    return this.http

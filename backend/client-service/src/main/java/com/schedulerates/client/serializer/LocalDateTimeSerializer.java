...
public class LocalDateTimeSerializer extends JsonSerializer<LocalDateTime> {
    ...
    /**
     * Serializes the given {@link LocalDateTime} value to an ISO-8601 formatted
     * string.
     *
     * @param value       the {@link LocalDateTime} value to serialize
     * @param gen         the {@link JsonGenerator} used to write the serialized
     *                    value
     * @param serializers the {@link SerializerProvider} that can be used to get
     *                    serializers for other types

package com.schedulerates.client.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.schedulerates.client.model.common.CustomError;
...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    /**
     * Handles authentication errors by sending a custom error response to the
     * client.
     * Sets the HTTP status to 401 Unauthorized and sends a JSON response with error
     * details.
     *
     * @param httpServletRequest      the request that resulted in an

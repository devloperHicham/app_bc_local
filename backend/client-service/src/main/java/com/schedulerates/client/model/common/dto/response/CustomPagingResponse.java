package com.schedulerates.client.model.common.dto.response;

import com.schedulerates.client.model.common.CustomPage;
...
/**
 * Represents a response object for custom paging named
 * {@link CustomPagingResponse<T>}.
 * Contains content list, page number, page size, total element count, and total
 * page count.
 *
...
public class CustomPagingResponse<T> {
    ...
    /**
     * Builder class for CustomPagingResponse, allowing initialization from a
     * CustomPage object.
     *
     * @param <T> Type of content in the response.
     */

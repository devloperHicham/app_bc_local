package com.schedulerates.user.model.user.entity;

import com.schedulerates.user.model.common.entity.BaseEntity;
import com.schedulerates.user.model.user.enums.TokenClaims;
 ...
 * This entity stores user-related information such as email, password, and
 * personal details.
 */
@Getter
@Setter

 ...
 */
@FeignClient(name = "comparison-service", path = "/api/v1/comparisons", configuration = FeignClientConfig.class)
public interface ComparisonServiceClient {
         ...
         */
        @GetMapping("/ports/{id}")
        boolean existsByPortId(@PathVariable String id, @RequestHeader("Authorization") String authHeader);

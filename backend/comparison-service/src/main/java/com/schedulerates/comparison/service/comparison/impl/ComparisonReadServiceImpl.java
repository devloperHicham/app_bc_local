...
public class ComparisonReadServiceImpl implements ComparisonReadService {
    ...
    public CustomPage<Comparison> getComparisons(ComparisonPagingRequest comparisonPagingRequest) {
        ...
        if (comparisonPagingRequest.getSearch() != null && !comparisonPagingRequest.getSearch().isEmpty()) {
            scheduleEntityPage = isAdmin
                    ...
                    : comparisonRepository.findByTextSearchAndCreatedBy(comparisonPagingRequest.getSearch(),
            ...
            scheduleEntityPage = isAdmin
                    ? comparisonRepository.findTodayActive("1", comparisonPagingRequest.toPageable())
    ...
    private boolean hasFilterValues(ComparisonPagingRequest comparisonPagingRequest) {
        return (comparisonPagingRequest.getPortFromId() != null && !comparisonPagingRequest.getPortFromId().isEmpty())
                ||
                (comparisonPagingRequest.getPortToId() != null && !comparisonPagingRequest.getPortToId().isEmpty()) ||
                (comparisonPagingRequest.getDateDepart() != null && !comparisonPagingRequest.getDateDepart().isEmpty())
                ||
                (comparisonPagingRequest.getDateArrive() != null && !comparisonPagingRequest.getDateArrive().isEmpty())
                ||
                (comparisonPagingRequest.getCompanyId() != null && !comparisonPagingRequest.getCompanyId().isEmpty());
    }

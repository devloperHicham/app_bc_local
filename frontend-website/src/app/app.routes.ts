...
export const routes: Routes = [
  ...
  },
  {
    path: "faq-general",
    loadComponent: () =>
      import("./template/home/faq-general/faq-general").then(
        (c) => c.FaqGeneral
      ),
  },
  {
  ...
  },
  {
    path: "terms-services",
    loadComponent: () =>
      import("./template/policy/terms-service/terms-service").then(
        (c) => c.TermsService
      ),
  },
  {
    ...
    loadComponent: () =>
      import(
        "./template/policy/cancellation-conditions/cancellation-conditions"
      ).then((c) => c.CancellationConditions),
  },
  {
    path: "payment-conditions",
    loadComponent: () =>
      import("./template/policy/payment-conditions/payment-conditions").then(
        (c) => c.PaymentConditions
      ),
  },
  {
    path: "privacy-policies",
    loadComponent: () =>
      import("./template/policy/privacy-policy/privacy-policy").then(
        (c) => c.PrivacyPolicy
      ),
  },
  {
    ...
    loadComponent: () =>
      import("./template/policy/conditions-dispute/conditions-dispute").then(
